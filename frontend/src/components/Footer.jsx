        ...
        <div>
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <a href="https://github.com/abhimanyu0x" target="_blank">
                <FaGithub size={30} />
              </a>
              <a href="https://www.linkedin.com/in/abhimanyuvermaa/" target="_blank">
                <FaLinkedin size={30} />
              </a>
              <a href="https://x.com/abhimanyu0x" target="_blank">
                <FaTwitter size={30} />
              </a>
            </div>
          </div>
